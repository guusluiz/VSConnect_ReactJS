...
function CadastroUsuario() {
    ...
    const [logradouro, setLougradouro] = useState<string>("")
    ...
    function cadastrarUsuario(event: any) {
        ...
        api.post("users", formData)
            ...
            .catch((error: any) => {
                console.log(error);
                alert("Falha ao cadastrar um usuário");
            })

    }

    function verificaCampoUpload(event: any) {
                    ...
                    <form className="cad_formulario" method="POST" onSubmit={cadastrarUsuario}>
                        ...
                        <div className="cad_box_input">
                            ...
                            <input
                                ...
                                onChange={(e) => setLougradouro(e.target.value)}
                                required
                            />
                        </div>
